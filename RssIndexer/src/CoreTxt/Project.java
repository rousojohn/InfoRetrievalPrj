...
public class Project {
    ...
    public static void main(String[] args){
        ...
        java.io.File file = new java.io.File(System.getProperties().getProperty("user.home")+"\\CollectionIndex\\DocumentsFile.txt");
        if(file.exists())
            file.delete();
         file = new java.io.File(System.getProperties().getProperty("user.home")+"\\CollectionIndex\\VocabularyFile.txt");
        if(file.exists())
            file.delete();
        file  = new java.io.File(System.getProperties().getProperty("user.home")+"\\CollectionIndex\\PostingFile.txt");
         if(file.exists())
            file.delete();
        file = new java.io.File(System.getProperties().getProperty("user.home")+"\\CollectionIndex");
        if(file.exists())
            file.delete();
        gui.Indexer.main1(args,false);
    }
    ...
    public static void main2(String[] args) throws IOException{
        ...
        //raf.writeUTF(String.valueOf(documentList.size())+"\n");
